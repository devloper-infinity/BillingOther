<%@ Page Title="" Language="C#" MasterPageFile="~/Accounts/Accounts.Master" AutoEventWireup="true" CodeBehind="CostPerRecord.aspx.cs" Inherits="BillingOther.Accounts.CostPerRecord" %>
                            ...
                            <div class="card-body">
                                <ul class="nav nav-tabs " role="tablist" style="margin-top: 5px!important;">
                                    <li class="nav-item active" id="Li1" runat="server">
                                        <a class="nav-link active" data-toggle="tab" href="#tab5" role="tab"><i class="fa fa-user"></i>&nbsp;&nbsp;Vendor Outsourcing Cost</a>
                                        <div class="slide"></div>
                                    </li>
