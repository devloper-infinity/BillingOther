<%@ Page Title="" Language="C#" MasterPageFile="~/Accounts/Accounts.Master" AutoEventWireup="true" CodeBehind="AllProjectBillingReport.aspx.cs" Inherits="BillingOther.Accounts.AllProjectBillingReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <center>
        <div id="dvError" runat="server" style="padding-bottom: 20px;">
    ...
    <div>
        ...
        <dx:ASPxPopupControl ID="popupSendInvReport" ClientInstanceName="popupSendInvReport" runat="server" AllowDragging="true" PopupHorizontalAlign="WindowCenter" HeaderText="Send Email" PopupVerticalAlign="WindowCenter" Width="700px">
                            ...
                            <dx:PanelContent ID="PanelContent1" runat="server">
                                <table class="table-condensed">
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Button ID="Button1" runat="server" Text="Send Mail" CssClass="btn btn-primary" OnClick="Button1_Click" /></td>
                                        <td></td>
                                    </tr>
                                </table>
        ...
        <dx:ASPxPopupControl ID="popupOrderFinalSummary" ClientInstanceName="popupOrderFinalSummary" runat="server" AllowDragging="true" PopupHorizontalAlign="WindowCenter" HeaderText="Update Invoice" PopupVerticalAlign="WindowCenter" Width="700px" Height="200px">
            <HeaderStyle Font-Bold="true" />
            <ContentCollection>
    ...
    <table class="table-condensed">
        <tr>
            ...
            <td>
                ...
                <asp:CalendarExtender ID="cal1" runat="server" TargetControlID="txtFromDate" Format="dd-MMM-yyyy"></asp:CalendarExtender>
            </td>
            <td>To:</td>
            <td>
                <asp:TextBox ID="txtToDate" runat="server" CssClass="form-control"></asp:TextBox>
                <asp:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="txtToDate" Format="dd-MMM-yyyy"></asp:CalendarExtender>
            </td>
            <td>
    ...
    <div style="overflow: auto;">
        <dx:ASPxGridViewExporter runat="server" ID="grdExport" GridViewID="grdClientDetails" FileName="Billing Summary Report"></dx:ASPxGridViewExporter>
        <dx:ASPxGridView ID="grdClientDetails" runat="server" AutoGenerateColumns="false" ClientInstanceName="grid" KeyFieldName="ProjectName;BillingPeriod" Theme="Default" OnDataBound="grdBilling_DataBound" OnCustomUnboundColumnData="grdClientDetails_CustomUnboundColumnData">
            <SettingsPager Mode="ShowAllRecords">
            </SettingsPager>
            <Settings ShowFilterRow="true" ShowHeaderFilterButton="true" />
            <TotalSummary>
                <dx:ASPxSummaryItem FieldName="OrderCount" SummaryType="Sum" DisplayFormat="n2" ShowInColumn="OrderCount" />
                <dx:ASPxSummaryItem FieldName="TotalAmount" SummaryType="Sum" DisplayFormat="n2" ShowInColumn="TotalAmount" />
            </TotalSummary>
            <Columns>
                ...
                <dx:GridViewDataTextColumn Caption="Domain" FieldName="Domain">
                    <HeaderStyle HorizontalAlign="Center" Font-Bold="True"></HeaderStyle>

                    <CellStyle HorizontalAlign="Center"></CellStyle>
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn Caption="Subdomain" FieldName="Subdomain">
                    <HeaderStyle HorizontalAlign="Center" Font-Bold="True"></HeaderStyle>
                ...
                <dx:GridViewDataTextColumn Caption="Order Count" FieldName="OrderCount" CellStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Font-Bold="true">
                    <HeaderCaptionTemplate>
                        <dx:ASPxLabel ID="lblOrderCount" Font-Bold="true" Font-Size="11px" runat="server" Text="" OnLoad="lblOrderCount_Load"></dx:ASPxLabel>
                    </HeaderCaptionTemplate>
                    <HeaderStyle HorizontalAlign="Center" Font-Bold="True"></HeaderStyle>
                    <CellStyle HorizontalAlign="Center"></CellStyle>
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn Caption="Total Amount" FieldName="TotalAmount" CellStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Font-Bold="true">
                    <HeaderCaptionTemplate>
                        <dx:ASPxLabel ID="lblTotalAmount" Font-Bold="true" Font-Size="11px" runat="server" Text="" OnLoad="lblTotalAmount_Load"></dx:ASPxLabel>
                    </HeaderCaptionTemplate>
                    <HeaderStyle HorizontalAlign="Center" Font-Bold="True"></HeaderStyle>
                ...
                <dx:GridViewDataTextColumn Caption="Invoice Number" FieldName="InvocieNumber" CellStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Font-Bold="true" Width="150px">
                    <HeaderStyle HorizontalAlign="Center" Font-Bold="True" Wrap="True"></HeaderStyle>
