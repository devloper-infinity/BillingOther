<%@ Page Title="" Language="C#" MasterPageFile="~/Accounts/Accounts.Master" AutoEventWireup="true" CodeBehind="ProjectDetailsFreight.aspx.cs" Inherits="BillingOther.Accounts.ProjectDetailsFreight" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Button ID="btnBack" runat="server" Text="Back" OnClick="btnBack_Click" CssClass="btn btn-warning" Style="float: right; margin-right: 150px;" ValidationGroup="1"></asp:Button>
     ...
     <div class="card-content">
        <div class="card-body">
            <ul class="nav nav-tabs " role="tablist">
                ...
                <li class="nav-item" id="tbpnlTyping" runat="server">
                    <a class="nav-link" data-toggle="tab" href="#tab3" role="tab"><i class="fa fa-cog"></i>&nbsp;&nbsp;Set Pricing</a>
                    <div class="slide"></div>
                </li>
            </ul>
            <div class="tab-content card-block" style="border: solid 1px #6c757d; margin-left: 5px;">
                ...
                <div class="tab-pane" id="tab2" role="tabpanel">
                    <table class="table table-border-style">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlBDM" runat="server" Width="200px" CssClass="form-control">
                                </asp:DropDownList>
                            ...
                            <td style="display: none;">
                                <asp:TextBox ID="txtRequestedDate" runat="server" Width="200px" placeholder="01-Jan-2016" CssClass="form-control" AutoCompleteType="Disabled"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddnda" runat="server" Width="200px" CssClass="form-control" onchange="NDAChange();">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlProjectStatus" Width="200px" runat="server" CssClass="form-control" onchange="GetLiveStopped();">
                                    <asp:ListItem Value="Select">Select</asp:ListItem>
                            ...
                            <td>
                                <asp:TextBox ID="txtExpectedVolume" Width="200px" runat="server" CssClass="form-control"></asp:TextBox>
                        ...
                        <tr id="trlivestopped" runat="server" style="display: none;">
                            ...
                            <td>
                                <asp:TextBox ID="txtStoppedRemark" Width="200px" runat="server" TextMode="MultiLine" CssClass="form-control"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtExpectedStartDate" Width="200px" runat="server" placeholder="01-Jan-2016" CssClass="form-control" AutoCompleteType="Disabled"></asp:TextBox>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlProjectDuration" Width="200px" runat="server" CssClass="form-control">
                                    <asp:ListItem Value="Select">Select</asp:ListItem>
                        ...
                        <tr>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtRateRevisionDate" Width="200px" runat="server" CssClass="form-control"></asp:TextBox>
                ...
                <div class="tab-pane" id="tab3" role="tabpanel">
                    ...
                    <table class="table table-border-style" id="tblOther" runat="server" style="display: none;">
                        <tr>
                            <td><b>Billing Type:</b></td>
                            <td>
                                <asp:DropDownList ID="ddlBillingBase" runat="server" CssClass="form-control" Width="200px" onchange="GetConfiguration(this);" ValidationGroup="Typing">
                                    <asp:ListItem Value="Select">Select</asp:ListItem>
                            ...
                            <td style="display: none;"><b>Billing Criteria:</b></td>
                            <td style="display: none;">
                                <asp:DropDownList ID="ddlBillingCriteria" runat="server" CssClass="form-control" Width="210px">
                                    <asp:ListItem Value="Select">Select</asp:ListItem>
                                    <asp:ListItem Value="Cancelled - Not to be billed">Cancelled - Not to be billed</asp:ListItem>
                                    <asp:ListItem Value="Cancelled - To be billed">Cancelled - To be billed</asp:ListItem>
                                </asp:DropDownList>
                            </td>
                            <td style="display: none;">
                                <asp:RequiredFieldValidator Enabled="false" ID="RequiredFieldValidator16" runat="server" ControlToValidate="ddlBillingCriteria" ErrorMessage="Please select Billing Criteria" InitialValue="Select" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td>
                                <asp:Button ID="btnShubmitTyping" runat="server" Text="Submit" OnClick="btnShubmitTyping_Click" CssClass="btn btn-primary" ValidationGroup="Typing" />
                            </td>
                            <td></td>
                            <td></td>
                            <td></td>
                    ...
                    <table class="table table-border-style" id="tbl771" runat="server" style="display: none;">
                        <tr>
                            <th>Parameter</th>
                            <th>Charge Type</th>
                            <th>Price</th>
                        ...
                        <tr>
                            <td></td>
                            <td>
                                <asp:Button ID="btnSubmit771" runat="server" Text="Submit" OnClick="btnSubmit771_Click" CssClass="btn btn-primary" ValidationGroup="Typing" />
                            </td>
                            <td></td>
                            <td></td>
                        </tr>
