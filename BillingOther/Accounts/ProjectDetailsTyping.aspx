<%@ Page Title="" Language="C#" MasterPageFile="~/Accounts/Accounts.Master" AutoEventWireup="true" CodeBehind="ProjectDetailsTyping.aspx.cs" Inherits="BillingOther.Accounts.ProjectDetailsTyping" %>
                ...
                <div class="tab-pane" id="tab3" role="tabpanel">
                    ...
                    <table class="table">
                        <tr>
                            ...
                            <td>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" ControlToValidate="ddlBillingCriteria" ErrorMessage="Please select Billing Criteria" InitialValue="Select" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td>
                                <asp:Button ID="btnShubmitTyping" runat="server" Text="Submit" OnClick="btnShubmitTyping_Click" ValidationGroup="Typing" />
                            </td>
                            <td></td>
                            <td></td>
                        </tr>
